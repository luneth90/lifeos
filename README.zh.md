...
目前仅确认 macOS 上的 Claude Code TUI / Codex TUI / OpenCode TUI 可以正常使用。GUI 桌面端和 Windows 环境尚未做验证与测试，暂时可能并不适用。

### 前置要求

开始前，请确保本机已安装 Obsidian，以及 Claude Code TUI / Codex TUI / OpenCode TUI 中至少一种。
