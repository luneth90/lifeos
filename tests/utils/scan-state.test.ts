...
import { createTempVault, createTestDb, type TempVault } from '../setup.js';
...
describe('buildScanStateRow', () => {
  it('builds tuple with correct layout', () => {
    const row = buildScanStateRow('path/file.md', 'hash123', 1700000000.5, 4096, '2024-06-01T00:00:00Z');
